...
class SnippetAnalyzerTest < Minitest::Test
  def test_scores_zero_for_empty_function
    ...
    assert_equal 0, function_analyzer.overall
  end
  ...
  def test_scores_one_for_simple_assignment
    code = "a = 1;"
    function_analyzer = SnippetAnalyzer.new( code )
    assert_equal 1, function_analyzer.overall
  end
  ...
  def test_scores_three_for_goto
    code = "    goto label;"
    function_analyzer = SnippetAnalyzer.new( code )
    assert_equal 3, function_analyzer.overall
  end

  def test_scores_two_for_new
    code = "    new AbraCadabra();"
    function_analyzer = SnippetAnalyzer.new( code )
    assert_equal 2, function_analyzer.overall
  end
